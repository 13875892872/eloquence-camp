...
<style scoped>
.stc{text-align:center;padding:36rpx;margin-bottom:24rpx;width:100%}.sqn{font-size:72rpx;font-weight:bold;color:var(--brand-primary);display:block}.sql{font-size:24rpx;color:#999;margin-top:6rpx;display:block}
