...
<style scoped>
.tbs{display:flex;margin-bottom:20rpx;gap:12rpx;width:100%}.tb{flex:1;text-align:center;padding:14rpx;font-size:26rpx;background:var(--bg-secondary);border-radius:32rpx}.tb.on{background:var(--brand-primary);color:#fff}
