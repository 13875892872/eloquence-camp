...
const list=ref([])
const sl=v=>({speech:'演讲',short_video:'短视频',livestream:'直播',interview:'面试',opening:'开场白'}[v]||v)
...
.it{font-size:28rpx;font-weight:bold;display:block}.im2{display:flex;justify-content:space-between;margin-top:10rpx;width:100%}.is{font-size:20rpx;color:var(--brand-primary)}.id{font-size:20rpx;color:#999}
</style>
