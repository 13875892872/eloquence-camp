...
<script setup>
import {ref,reactive} from 'vue';import {onShow,onUnload} from '@dcloudio/uni-app';import api,{BASE_API} from '@/api/request'
...
function togglePlay(record){
  ...
  const fullUrl=record.audio_url.startsWith('http')?record.audio_url:(BASE_API.replace('/api','')+record.audio_url)
