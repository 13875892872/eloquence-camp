...
.mc{background:#fff;border-radius:24rpx;overflow:hidden;width:100%;box-sizing:border-box}.mt{margin-top:20rpx}
.mi{display:flex;justify-content:space-between;align-items:center;padding:24rpx;border-bottom:1rpx solid #f5f5f5;font-size:28rpx;width:100%;box-sizing:border-box}.ma{color:#ccc;flex-shrink:0}
</style>
