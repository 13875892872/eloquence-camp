...
<style scoped>
.stats{display:flex;background:linear-gradient(135deg,#FF6B35,#FF8C5A);border-radius:24rpx;padding:36rpx 0;margin-bottom:24rpx;width:100%}
...
.card{background:#fff;border-radius:24rpx;padding:24rpx;margin-bottom:16rpx;width:100%;box-sizing:border-box;overflow:hidden}
...
.task{background:#fff;border-radius:24rpx;padding:24rpx;margin-bottom:14rpx;width:100%;box-sizing:border-box;overflow:hidden}.task.locked{opacity:.5}.task.done{border-left:6rpx solid #52C41A}
